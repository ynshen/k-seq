...
if [ -z $miss ];
  then
    echo "-----Don't use completely_miss_the_point module"
    echo "-----Don't use completely_miss_the_point module" >> "$outdir/log.txt"
  else
    echo "-----Use completely_miss_the_point module"
