...
<a href="https://www.codecogs.com/eqnedit.php?latex=F_{s,&space;\text{Reacted}}&space;=&space;\frac{m_{s,&space;t}}{m_{s,&space;t_0}}=&space;A(1-exp(-\alpha&space;k&space;c_{BFO}&space;(t-t_0)))" target="_blank"><img src="https://latex.codecogs.com/svg.latex?F_{s,&space;\text{Reacted}}&space;=&space;\frac{m_{s,&space;t}}{m_{s,&space;t_0}}=&space;A(1-exp(-\alpha&space;k&space;c_{BFO}&space;(t-t_0)))" title="F_{s, \text{Reacted}} = \frac{m_{s, t}}{m_{s, t_0}}= A(1-exp(-\alpha k c_{BFO} (t-t_0)))" /></a>

where

<a href="https://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;&t&space;\quad&space;&&space;\text{reaction&space;time&space;t}&space;\\&space;&t_0&space;\quad&space;&&space;\text{initial&space;time}&space;\\&space;&c_{BFO}&space;\quad&space;&&space;\text{initial&space;concentration&space;of&space;BFO}&space;\\&space;&m&space;\quad&space;&&space;\text{amount&space;of&space;seq&space;s,&space;e.g.&space;fmol}&space;\\&space;&\alpha&space;\quad&space;&&space;\text{parameter&space;adjust&space;for&space;degradation&space;of&space;BFO}&space;\\&space;&A&space;\quad&space;&&space;\text{fraction&space;of&space;active&space;RNA}&space;\\&space;&k&space;\quad&space;&&space;\text{kinetic&space;coefficient}&space;\\&space;\end{aligned}" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\begin{aligned}&space;&t&space;\quad&space;&&space;\text{reaction&space;time&space;t}&space;\\&space;&t_0&space;\quad&space;&&space;\text{initial&space;time}&space;\\&space;&c_{BFO}&space;\quad&space;&&space;\text{initial&space;concentration&space;of&space;BFO}&space;\\&space;&m&space;\quad&space;&&space;\text{amount&space;of&space;seq&space;s,&space;e.g.&space;fmol}&space;\\&space;&\alpha&space;\quad&space;&&space;\text{parameter&space;adjust&space;for&space;degradation&space;of&space;BFO}&space;\\&space;&A&space;\quad&space;&&space;\text{fraction&space;of&space;active&space;RNA}&space;\\&space;&k&space;\quad&space;&&space;\text{kinetic&space;coefficient}&space;\\&space;\end{aligned}" title="\begin{aligned} &t \quad & \text{reaction time t} \\ &t_0 \quad & \text{initial time} \\ &c_{BFO} \quad & \text{initial concentration of BFO} \\ &m \quad & \text{amount of seq s, e.g. fmol} \\ &\alpha \quad & \text{parameter adjust for degradation of BFO} \\ &A \quad & \text{fraction of active RNA} \\ &k \quad & \text{kinetic coefficient} \\ \end{aligned}" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=q_i&space;=&space;\frac{\text{Spike&space;in&space;amount&space;(mol)}}{\text{Spike&space;in&space;counts}}&space;\times&space;\text{Total&space;counts&space;N}" target="_blank"><img src="https://latex.codecogs.com/svg.latex?q_i&space;=&space;\frac{\text{Spike&space;in&space;amount&space;(mol)}}{\text{Spike&space;in&space;counts}}&space;\times&space;\text{Total&space;counts&space;N}" title="q_i = \frac{\text{Spike in amount (mol)}}{\text{Spike in counts}} \times \text{Total counts N}" /></a>

Thus, the absolute amount of Seq *s* with count *n* is <a href="https://www.codecogs.com/eqnedit.php?latex=\inline&space;\frac{n}{N}q_i" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\inline&space;\frac{n}{N}q_i" title="\frac{n}{N}q_i" /></a>
