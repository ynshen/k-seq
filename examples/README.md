...
<img src="https://latex.codecogs.com/svg.latex?q_i&space;=&space;\frac{\text{Spike&space;in&space;amount&space;(mol)}}{\text{Spike&space;in&space;counts}}&space;\times&space;\text{Total&space;counts&space;N}" title="q_i = \frac{\text{Spike in amount (mol)}}{\text{Spike in counts}} \times \text{Total counts N}" /></a>

Thus, the absolute amount of Seq *s* with count *n* is <img src="https://latex.codecogs.com/svg.latex?\inline&space;\frac{n}{N}q_i" title="\frac{n}{N}q_i" /></a>
